// Benchmark "c499.blif" written by ABC on Wed Jan 17 21:29:00 2024
...
module \c499.blif  ( 
  ...
  nor2 g004(.a(Gid18), .b(Gid17), .O(new_n78_));
  inv1 g005(.a(Gid17), .O(new_n79_));
  inv1 g006(.a(Gid18), .O(new_n80_));
  ...
  nor2 g011(.a(Gid19), .b(new_n84_), .O(new_n85_));
  inv1 g012(.a(Gid19), .O(new_n86_));
  ...
  nor2 g024(.a(Gid8), .b(Gid4), .O(new_n98_));
  inv1 g025(.a(Gid4), .O(new_n99_));
  inv1 g026(.a(Gid8), .O(new_n100_));
  ...
  nor2 g031(.a(Gid12), .b(new_n104_), .O(new_n105_));
  inv1 g032(.a(Gid12), .O(new_n106_));
  ...
  nor2 g040(.a(Gid22), .b(Gid21), .O(new_n114_));
  inv1 g041(.a(Gid21), .O(new_n115_));
  inv1 g042(.a(Gid22), .O(new_n116_));
  ...
  nor2 g047(.a(Gid23), .b(new_n120_), .O(new_n121_));
  inv1 g048(.a(Gid23), .O(new_n122_));
  ...
  nor2 g067(.a(Gid6), .b(Gid5), .O(new_n141_));
  inv1 g068(.a(Gid5), .O(new_n142_));
  inv1 g069(.a(Gid6), .O(new_n143_));
  ...
  nor2 g073(.a(Gid7), .b(new_n99_), .O(new_n147_));
  inv1 g074(.a(Gid7), .O(new_n148_));
  ...
  nor2 g086(.a(Gid14), .b(Gid13), .O(new_n160_));
  inv1 g087(.a(Gid13), .O(new_n161_));
  inv1 g088(.a(Gid14), .O(new_n162_));
  ...
  nor2 g092(.a(Gid15), .b(new_n106_), .O(new_n166_));
  inv1 g093(.a(Gid15), .O(new_n167_));
  ...
  nor2 g101(.a(Gid31), .b(new_n86_), .O(new_n175_));
  inv1 g102(.a(Gid31), .O(new_n176_));
  nor2 g103(.a(new_n176_), .b(Gid19), .O(new_n177_));
  nor2 g104(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  inv1 g105(.a(new_n178_), .O(new_n179_));
  nor2 g106(.a(Gid27), .b(new_n122_), .O(new_n180_));
  inv1 g107(.a(Gid27), .O(new_n181_));
  nor2 g108(.a(new_n181_), .b(Gid23), .O(new_n182_));
  nor2 g109(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  nor2 g110(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  inv1 g111(.a(new_n183_), .O(new_n185_));
  nor2 g112(.a(new_n185_), .b(new_n178_), .O(new_n186_));
  ...
  nor2 g125(.a(Gid2), .b(Gid1), .O(new_n199_));
  inv1 g126(.a(Gid1), .O(new_n200_));
  inv1 g127(.a(Gid2), .O(new_n201_));
  ...
  nor2 g131(.a(Gid3), .b(new_n104_), .O(new_n205_));
  inv1 g132(.a(Gid3), .O(new_n206_));
  ...
  nor2 g144(.a(Gid10), .b(Gid9), .O(new_n218_));
  inv1 g145(.a(Gid9), .O(new_n219_));
  inv1 g146(.a(Gid10), .O(new_n220_));
  ...
  nor2 g150(.a(Gid11), .b(new_n100_), .O(new_n224_));
  inv1 g151(.a(Gid11), .O(new_n225_));
  ...
  nor2 g159(.a(Gid30), .b(new_n80_), .O(new_n233_));
  inv1 g160(.a(Gid30), .O(new_n234_));
  nor2 g161(.a(new_n234_), .b(Gid18), .O(new_n235_));
  nor2 g162(.a(new_n235_), .b(new_n233_), .O(new_n236_));
  inv1 g163(.a(new_n236_), .O(new_n237_));
  nor2 g164(.a(Gid26), .b(new_n116_), .O(new_n238_));
  inv1 g165(.a(Gid26), .O(new_n239_));
  nor2 g166(.a(new_n239_), .b(Gid22), .O(new_n240_));
  nor2 g167(.a(new_n240_), .b(new_n238_), .O(new_n241_));
  nor2 g168(.a(new_n241_), .b(new_n237_), .O(new_n242_));
  inv1 g169(.a(new_n241_), .O(new_n243_));
  nor2 g170(.a(new_n243_), .b(new_n236_), .O(new_n244_));
  ...
  nor2 g190(.a(Gid28), .b(new_n84_), .O(new_n264_));
  inv1 g191(.a(Gid28), .O(new_n265_));
  nor2 g192(.a(new_n265_), .b(Gid16), .O(new_n266_));
  nor2 g193(.a(new_n266_), .b(new_n264_), .O(new_n267_));
  inv1 g194(.a(new_n267_), .O(new_n268_));
  nor2 g195(.a(Gid24), .b(new_n120_), .O(new_n269_));
  inv1 g196(.a(Gid24), .O(new_n270_));
  nor2 g197(.a(new_n270_), .b(Gid20), .O(new_n271_));
  ...
  nor2 g219(.a(Gid29), .b(new_n79_), .O(new_n293_));
  inv1 g220(.a(Gid29), .O(new_n294_));
  nor2 g221(.a(new_n294_), .b(Gid17), .O(new_n295_));
  nor2 g222(.a(new_n295_), .b(new_n293_), .O(new_n296_));
  inv1 g223(.a(new_n296_), .O(new_n297_));
  nor2 g224(.a(Gid25), .b(new_n115_), .O(new_n298_));
  inv1 g225(.a(Gid25), .O(new_n299_));
  nor2 g226(.a(new_n299_), .b(Gid21), .O(new_n300_));
  nor2 g227(.a(new_n300_), .b(new_n298_), .O(new_n301_));
  nor2 g228(.a(new_n301_), .b(new_n297_), .O(new_n302_));
  inv1 g229(.a(new_n301_), .O(new_n303_));
  nor2 g230(.a(new_n303_), .b(new_n296_), .O(new_n304_));
  ...
  nor2 g245(.a(Gid30), .b(Gid29), .O(new_n319_));
  nor2 g246(.a(new_n234_), .b(new_n294_), .O(new_n320_));
  nor2 g247(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  inv1 g248(.a(new_n321_), .O(new_n322_));
  nor2 g249(.a(Gid31), .b(new_n265_), .O(new_n323_));
  nor2 g250(.a(new_n176_), .b(Gid28), .O(new_n324_));
  ...
  nor2 g261(.a(Gid9), .b(Gid5), .O(new_n335_));
  nor2 g262(.a(new_n219_), .b(new_n142_), .O(new_n336_));
  nor2 g263(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  inv1 g264(.a(new_n337_), .O(new_n338_));
  nor2 g265(.a(Gid13), .b(new_n200_), .O(new_n339_));
  nor2 g266(.a(new_n161_), .b(Gid1), .O(new_n340_));
  ...
  nor2 g273(.a(Gid26), .b(Gid25), .O(new_n347_));
  nor2 g274(.a(new_n239_), .b(new_n299_), .O(new_n348_));
  nor2 g275(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  inv1 g276(.a(new_n349_), .O(new_n350_));
  nor2 g277(.a(Gid27), .b(new_n270_), .O(new_n351_));
  nor2 g278(.a(new_n181_), .b(Gid24), .O(new_n352_));
  nor2 g279(.a(new_n352_), .b(new_n351_), .O(new_n353_));
  inv1 g280(.a(new_n353_), .O(new_n354_));
  nor2 g281(.a(new_n354_), .b(new_n350_), .O(new_n355_));
  nor2 g282(.a(new_n353_), .b(new_n349_), .O(new_n356_));
  ...
  inv1 g296(.a(Gic2), .O(new_n370_));
  nor2 g297(.a(new_n75_), .b(new_n370_), .O(new_n371_));
  inv1 g298(.a(new_n371_), .O(new_n372_));
  nor2 g299(.a(new_n372_), .b(new_n93_), .O(new_n373_));
  nor2 g300(.a(new_n371_), .b(new_n92_), .O(new_n374_));
  nor2 g301(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  inv1 g302(.a(new_n375_), .O(new_n376_));
  nor2 g303(.a(Gid14), .b(new_n201_), .O(new_n377_));
  nor2 g304(.a(new_n162_), .b(Gid2), .O(new_n378_));
  nor2 g305(.a(new_n378_), .b(new_n377_), .O(new_n379_));
  inv1 g306(.a(new_n379_), .O(new_n380_));
  nor2 g307(.a(Gid10), .b(new_n143_), .O(new_n381_));
  nor2 g308(.a(new_n220_), .b(Gid6), .O(new_n382_));
  ...
  nor2 g314(.a(new_n387_), .b(new_n359_), .O(new_n388_));
  inv1 g315(.a(new_n387_), .O(new_n389_));
  nor2 g316(.a(new_n389_), .b(new_n357_), .O(new_n390_));
  ...
  inv1 g322(.a(Gic3), .O(new_n396_));
  nor2 g323(.a(new_n75_), .b(new_n396_), .O(new_n397_));
  inv1 g324(.a(new_n397_), .O(new_n398_));
  nor2 g325(.a(new_n398_), .b(new_n130_), .O(new_n399_));
  nor2 g326(.a(new_n397_), .b(new_n128_), .O(new_n400_));
  nor2 g327(.a(new_n400_), .b(new_n399_), .O(new_n401_));
  inv1 g328(.a(new_n401_), .O(new_n402_));
  nor2 g329(.a(Gid15), .b(new_n206_), .O(new_n403_));
  nor2 g330(.a(new_n167_), .b(Gid3), .O(new_n404_));
  nor2 g331(.a(new_n404_), .b(new_n403_), .O(new_n405_));
  inv1 g332(.a(new_n405_), .O(new_n406_));
  nor2 g333(.a(Gid11), .b(new_n148_), .O(new_n407_));
  nor2 g334(.a(new_n225_), .b(Gid7), .O(new_n408_));
  ...
  nor2 g340(.a(new_n413_), .b(new_n330_), .O(new_n414_));
  inv1 g341(.a(new_n413_), .O(new_n415_));
  nor2 g342(.a(new_n415_), .b(new_n329_), .O(new_n416_));
  ...
  inv1 g351(.a(new_n421_), .O(new_n425_));
  nor2 g352(.a(new_n425_), .b(new_n395_), .O(new_n426_));
  inv1 g353(.a(new_n395_), .O(new_n427_));
  nor2 g354(.a(new_n421_), .b(new_n427_), .O(new_n428_));
  ...
  nor2 g373(.a(new_n444_), .b(new_n200_), .O(new_n447_));
  ...
  nor2 g379(.a(new_n450_), .b(new_n201_), .O(new_n453_));
  ...
  nor2 g385(.a(new_n456_), .b(new_n206_), .O(new_n459_));
  ...
  nor2 g396(.a(new_n467_), .b(new_n99_), .O(new_n470_));
  ...
  nor2 g402(.a(new_n473_), .b(new_n142_), .O(new_n476_));
  ...
  nor2 g408(.a(new_n479_), .b(new_n143_), .O(new_n482_));
  ...
  nor2 g414(.a(new_n485_), .b(new_n148_), .O(new_n488_));
  ...
  nor2 g427(.a(new_n498_), .b(new_n100_), .O(new_n501_));
  ...
  nor2 g433(.a(new_n504_), .b(new_n219_), .O(new_n507_));
  ...
  nor2 g439(.a(new_n510_), .b(new_n220_), .O(new_n513_));
  ...
  nor2 g445(.a(new_n516_), .b(new_n225_), .O(new_n519_));
  ...
  nor2 g455(.a(new_n526_), .b(new_n106_), .O(new_n529_));
  ...
  nor2 g461(.a(new_n532_), .b(new_n161_), .O(new_n535_));
  ...
  nor2 g467(.a(new_n538_), .b(new_n162_), .O(new_n541_));
  ...
  nor2 g473(.a(new_n544_), .b(new_n167_), .O(new_n547_));
  nor2 g474(.a(new_n547_), .b(new_n546_), .O(new_n548_));
  inv1 g475(.a(new_n548_), .O(God15));
  inv1 g476(.a(new_n368_), .O(new_n550_));
  inv1 g477(.a(new_n428_), .O(new_n551_));
  nor2 g478(.a(new_n463_), .b(new_n255_), .O(new_n552_));
  nor2 g479(.a(new_n313_), .b(new_n284_), .O(new_n553_));
  inv1 g480(.a(new_n553_), .O(new_n554_));
  nor2 g481(.a(new_n554_), .b(new_n552_), .O(new_n555_));
  nor2 g482(.a(new_n492_), .b(new_n314_), .O(new_n556_));
  nor2 g483(.a(new_n253_), .b(new_n195_), .O(new_n557_));
  ...
  nor2 g500(.a(new_n571_), .b(new_n79_), .O(new_n574_));
  ...
  nor2 g506(.a(new_n577_), .b(new_n80_), .O(new_n580_));
  ...
  nor2 g512(.a(new_n583_), .b(new_n86_), .O(new_n586_));
  nor2 g513(.a(new_n586_), .b(new_n585_), .O(new_n587_));
  inv1 g514(.a(new_n587_), .O(God19));
  inv1 g515(.a(new_n426_), .O(new_n589_));
  nor2 g516(.a(new_n560_), .b(new_n589_), .O(new_n590_));
  inv1 g517(.a(new_n590_), .O(new_n591_));
  nor2 g518(.a(new_n591_), .b(new_n550_), .O(new_n592_));
  inv1 g519(.a(new_n592_), .O(new_n593_));
  nor2 g520(.a(new_n593_), .b(new_n285_), .O(new_n594_));
  inv1 g521(.a(new_n594_), .O(new_n595_));
  nor2 g522(.a(new_n595_), .b(Gid20), .O(new_n596_));
  nor2 g523(.a(new_n594_), .b(new_n120_), .O(new_n597_));
  nor2 g524(.a(new_n597_), .b(new_n596_), .O(new_n598_));
  inv1 g525(.a(new_n598_), .O(God20));
  nor2 g526(.a(new_n593_), .b(new_n491_), .O(new_n600_));
  inv1 g527(.a(new_n600_), .O(new_n601_));
  nor2 g528(.a(new_n601_), .b(Gid21), .O(new_n602_));
  nor2 g529(.a(new_n600_), .b(new_n115_), .O(new_n603_));
  nor2 g530(.a(new_n603_), .b(new_n602_), .O(new_n604_));
  inv1 g531(.a(new_n604_), .O(God21));
  nor2 g532(.a(new_n593_), .b(new_n254_), .O(new_n606_));
  inv1 g533(.a(new_n606_), .O(new_n607_));
  nor2 g534(.a(new_n607_), .b(Gid22), .O(new_n608_));
  nor2 g535(.a(new_n606_), .b(new_n116_), .O(new_n609_));
  nor2 g536(.a(new_n609_), .b(new_n608_), .O(new_n610_));
  inv1 g537(.a(new_n610_), .O(God22));
  nor2 g538(.a(new_n593_), .b(new_n462_), .O(new_n612_));
  inv1 g539(.a(new_n612_), .O(new_n613_));
  nor2 g540(.a(new_n613_), .b(Gid23), .O(new_n614_));
  nor2 g541(.a(new_n612_), .b(new_n122_), .O(new_n615_));
  nor2 g542(.a(new_n615_), .b(new_n614_), .O(new_n616_));
  inv1 g543(.a(new_n616_), .O(God23));
  inv1 g544(.a(new_n367_), .O(new_n618_));
  nor2 g545(.a(new_n562_), .b(new_n618_), .O(new_n619_));
  ...
  nor2 g550(.a(new_n621_), .b(new_n270_), .O(new_n624_));
  ...
  nor2 g556(.a(new_n627_), .b(new_n299_), .O(new_n630_));
  ...
  nor2 g562(.a(new_n633_), .b(new_n239_), .O(new_n636_));
  ...
  nor2 g568(.a(new_n639_), .b(new_n181_), .O(new_n642_));
  nor2 g569(.a(new_n642_), .b(new_n641_), .O(new_n643_));
  inv1 g570(.a(new_n643_), .O(God27));
  nor2 g571(.a(new_n591_), .b(new_n618_), .O(new_n645_));
  ...
  nor2 g576(.a(new_n647_), .b(new_n265_), .O(new_n650_));
  ...
  nor2 g582(.a(new_n653_), .b(new_n294_), .O(new_n656_));
  ...
  nor2 g588(.a(new_n659_), .b(new_n234_), .O(new_n662_));
  ...
  nor2 g594(.a(new_n665_), .b(new_n176_), .O(new_n668_));
