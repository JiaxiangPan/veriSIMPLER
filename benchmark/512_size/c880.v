// Benchmark "c880.blif" written by ABC on Wed Jan 17 21:28:57 2024
...
module \c880.blif  ( 
  ...
  nor2 g067(.a(G96gat), .b(G91gat), .O(new_n154_));
  inv1 g068(.a(G91gat), .O(new_n155_));
  inv1 g069(.a(G96gat), .O(new_n156_));
  nor2 g070(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nor2 g071(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  inv1 g072(.a(new_n158_), .O(new_n159_));
  inv1 g073(.a(G130gat), .O(new_n160_));
  nor2 g074(.a(G116gat), .b(G111gat), .O(new_n161_));
  inv1 g075(.a(G111gat), .O(new_n162_));
  inv1 g076(.a(G116gat), .O(new_n163_));
  nor2 g077(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nor2 g078(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  inv1 g079(.a(new_n165_), .O(new_n166_));
  nor2 g080(.a(new_n166_), .b(new_n160_), .O(new_n167_));
  nor2 g081(.a(new_n165_), .b(G130gat), .O(new_n168_));
  nor2 g082(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nor2 g083(.a(new_n169_), .b(new_n159_), .O(new_n170_));
  inv1 g084(.a(new_n169_), .O(new_n171_));
  nor2 g085(.a(new_n171_), .b(new_n158_), .O(new_n172_));
  nor2 g086(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  inv1 g087(.a(new_n173_), .O(new_n174_));
  inv1 g088(.a(G135gat), .O(new_n175_));
  nor2 g089(.a(G126gat), .b(G121gat), .O(new_n176_));
  inv1 g090(.a(G121gat), .O(new_n177_));
  inv1 g091(.a(G126gat), .O(new_n178_));
  nor2 g092(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nor2 g093(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  inv1 g094(.a(new_n180_), .O(new_n181_));
  nor2 g095(.a(new_n181_), .b(new_n175_), .O(new_n182_));
  nor2 g096(.a(new_n180_), .b(G135gat), .O(new_n183_));
  nor2 g097(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  inv1 g098(.a(new_n184_), .O(new_n185_));
  inv1 g099(.a(G101gat), .O(new_n186_));
  nor2 g100(.a(G106gat), .b(new_n186_), .O(new_n187_));
  inv1 g101(.a(G106gat), .O(new_n188_));
  nor2 g102(.a(new_n188_), .b(G101gat), .O(new_n189_));
  ...
  nor2 g109(.a(new_n195_), .b(new_n174_), .O(new_n196_));
  nor2 g110(.a(new_n194_), .b(new_n173_), .O(new_n197_));
  nor2 g111(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  inv1 g112(.a(new_n198_), .O(G767gat));
  nor2 g113(.a(G165gat), .b(G159gat), .O(new_n200_));
  inv1 g114(.a(G159gat), .O(new_n201_));
  inv1 g115(.a(G165gat), .O(new_n202_));
  nor2 g116(.a(new_n202_), .b(new_n201_), .O(new_n203_));
  nor2 g117(.a(new_n203_), .b(new_n200_), .O(new_n204_));
  inv1 g118(.a(new_n204_), .O(new_n205_));
  nor2 g119(.a(G189gat), .b(G183gat), .O(new_n206_));
  inv1 g120(.a(G183gat), .O(new_n207_));
  inv1 g121(.a(G189gat), .O(new_n208_));
  nor2 g122(.a(new_n208_), .b(new_n207_), .O(new_n209_));
  nor2 g123(.a(new_n209_), .b(new_n206_), .O(new_n210_));
  inv1 g124(.a(new_n210_), .O(new_n211_));
  nor2 g125(.a(new_n211_), .b(new_n160_), .O(new_n212_));
  nor2 g126(.a(new_n210_), .b(G130gat), .O(new_n213_));
  nor2 g127(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nor2 g128(.a(new_n214_), .b(new_n205_), .O(new_n215_));
  inv1 g129(.a(new_n214_), .O(new_n216_));
  nor2 g130(.a(new_n216_), .b(new_n204_), .O(new_n217_));
  nor2 g131(.a(new_n217_), .b(new_n215_), .O(new_n218_));
  inv1 g132(.a(new_n218_), .O(new_n219_));
  inv1 g133(.a(G207gat), .O(new_n220_));
  nor2 g134(.a(G201gat), .b(G195gat), .O(new_n221_));
  inv1 g135(.a(G195gat), .O(new_n222_));
  inv1 g136(.a(G201gat), .O(new_n223_));
  nor2 g137(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nor2 g138(.a(new_n224_), .b(new_n221_), .O(new_n225_));
  inv1 g139(.a(new_n225_), .O(new_n226_));
  nor2 g140(.a(new_n226_), .b(new_n220_), .O(new_n227_));
  nor2 g141(.a(new_n225_), .b(G207gat), .O(new_n228_));
  nor2 g142(.a(new_n228_), .b(new_n227_), .O(new_n229_));
  inv1 g143(.a(new_n229_), .O(new_n230_));
  inv1 g144(.a(G171gat), .O(new_n231_));
  nor2 g145(.a(G177gat), .b(new_n231_), .O(new_n232_));
  inv1 g146(.a(G177gat), .O(new_n233_));
  nor2 g147(.a(new_n233_), .b(G171gat), .O(new_n234_));
  ...
  nor2 g154(.a(new_n240_), .b(new_n219_), .O(new_n241_));
  nor2 g155(.a(new_n239_), .b(new_n218_), .O(new_n242_));
  ...
  nor2 g182(.a(new_n268_), .b(new_n178_), .O(new_n269_));
  ...
  nor2 g193(.a(new_n279_), .b(new_n223_), .O(new_n280_));
  inv1 g194(.a(G261gat), .O(new_n281_));
  inv1 g195(.a(new_n279_), .O(new_n282_));
  nor2 g196(.a(new_n282_), .b(G201gat), .O(new_n283_));
  nor2 g197(.a(new_n283_), .b(new_n281_), .O(new_n284_));
  inv1 g198(.a(new_n284_), .O(new_n285_));
  nor2 g199(.a(new_n285_), .b(new_n280_), .O(new_n286_));
  inv1 g200(.a(G219gat), .O(new_n287_));
  nor2 g201(.a(new_n283_), .b(new_n280_), .O(new_n288_));
  nor2 g202(.a(new_n288_), .b(G261gat), .O(new_n289_));
  nor2 g203(.a(new_n289_), .b(new_n287_), .O(new_n290_));
  inv1 g204(.a(new_n290_), .O(new_n291_));
  nor2 g205(.a(new_n291_), .b(new_n286_), .O(new_n292_));
  inv1 g206(.a(G228gat), .O(new_n293_));
  inv1 g207(.a(new_n288_), .O(new_n294_));
  nor2 g208(.a(new_n294_), .b(new_n293_), .O(new_n295_));
  inv1 g209(.a(G237gat), .O(new_n296_));
  nor2 g210(.a(new_n296_), .b(new_n223_), .O(new_n297_));
  ...
  nor2 g221(.a(new_n307_), .b(new_n223_), .O(new_n308_));
  inv1 g222(.a(G210gat), .O(new_n309_));
  nor2 g223(.a(new_n309_), .b(new_n177_), .O(new_n310_));
  ...
  nor2 g237(.a(new_n268_), .b(new_n162_), .O(new_n324_));
  inv1 g238(.a(G143gat), .O(new_n325_));
  nor2 g239(.a(new_n252_), .b(new_n325_), .O(new_n326_));
  nor2 g240(.a(new_n326_), .b(new_n276_), .O(new_n327_));
  inv1 g241(.a(new_n327_), .O(new_n328_));
  nor2 g242(.a(new_n328_), .b(new_n324_), .O(new_n329_));
  inv1 g243(.a(new_n329_), .O(new_n330_));
  nor2 g244(.a(new_n330_), .b(G183gat), .O(new_n331_));
  nor2 g245(.a(new_n329_), .b(new_n207_), .O(new_n332_));
  nor2 g246(.a(new_n332_), .b(new_n331_), .O(new_n333_));
  nor2 g247(.a(new_n284_), .b(new_n280_), .O(new_n334_));
  nor2 g248(.a(new_n268_), .b(new_n163_), .O(new_n335_));
  inv1 g249(.a(G146gat), .O(new_n336_));
  nor2 g250(.a(new_n252_), .b(new_n336_), .O(new_n337_));
  nor2 g251(.a(new_n337_), .b(new_n276_), .O(new_n338_));
  inv1 g252(.a(new_n338_), .O(new_n339_));
  nor2 g253(.a(new_n339_), .b(new_n335_), .O(new_n340_));
  inv1 g254(.a(new_n340_), .O(new_n341_));
  nor2 g255(.a(new_n341_), .b(G189gat), .O(new_n342_));
  nor2 g256(.a(new_n268_), .b(new_n177_), .O(new_n343_));
  inv1 g257(.a(G149gat), .O(new_n344_));
  nor2 g258(.a(new_n252_), .b(new_n344_), .O(new_n345_));
  nor2 g259(.a(new_n345_), .b(new_n276_), .O(new_n346_));
  inv1 g260(.a(new_n346_), .O(new_n347_));
  nor2 g261(.a(new_n347_), .b(new_n343_), .O(new_n348_));
  ...
  nor2 g267(.a(new_n340_), .b(new_n208_), .O(new_n354_));
  nor2 g268(.a(new_n348_), .b(new_n222_), .O(new_n355_));
  ...
  nor2 g276(.a(new_n362_), .b(new_n287_), .O(new_n363_));
  ...
  nor2 g280(.a(new_n296_), .b(new_n207_), .O(new_n367_));
  nor2 g281(.a(new_n367_), .b(G246gat), .O(new_n368_));
  nor2 g282(.a(new_n368_), .b(new_n329_), .O(new_n369_));
  nor2 g283(.a(new_n307_), .b(new_n207_), .O(new_n370_));
  nor2 g284(.a(new_n309_), .b(new_n188_), .O(new_n371_));
  ...
  nor2 g302(.a(new_n388_), .b(new_n287_), .O(new_n389_));
  ...
  nor2 g306(.a(new_n296_), .b(new_n208_), .O(new_n393_));
  nor2 g307(.a(new_n393_), .b(G246gat), .O(new_n394_));
  nor2 g308(.a(new_n394_), .b(new_n340_), .O(new_n395_));
  nor2 g309(.a(new_n307_), .b(new_n208_), .O(new_n396_));
  nor2 g310(.a(new_n309_), .b(new_n162_), .O(new_n397_));
  ...
  nor2 g325(.a(new_n383_), .b(new_n287_), .O(new_n412_));
  ...
  nor2 g329(.a(new_n296_), .b(new_n222_), .O(new_n416_));
  nor2 g330(.a(new_n416_), .b(G246gat), .O(new_n417_));
  nor2 g331(.a(new_n417_), .b(new_n348_), .O(new_n418_));
  nor2 g332(.a(new_n307_), .b(new_n222_), .O(new_n419_));
  nor2 g333(.a(new_n309_), .b(new_n163_), .O(new_n420_));
  ...
  nor2 g346(.a(new_n268_), .b(new_n155_), .O(new_n433_));
  nor2 g347(.a(new_n250_), .b(new_n137_), .O(new_n434_));
  inv1 g348(.a(new_n434_), .O(new_n435_));
  nor2 g349(.a(new_n435_), .b(new_n325_), .O(new_n436_));
  ...
  nor2 g360(.a(new_n446_), .b(new_n201_), .O(new_n447_));
  nor2 g361(.a(new_n268_), .b(new_n188_), .O(new_n448_));
  nor2 g362(.a(new_n435_), .b(new_n245_), .O(new_n449_));
  inv1 g363(.a(G152gat), .O(new_n450_));
  nor2 g364(.a(new_n450_), .b(new_n437_), .O(new_n451_));
  nor2 g365(.a(new_n451_), .b(new_n441_), .O(new_n452_));
  inv1 g366(.a(new_n452_), .O(new_n453_));
  nor2 g367(.a(new_n453_), .b(new_n449_), .O(new_n454_));
  inv1 g368(.a(new_n454_), .O(new_n455_));
  nor2 g369(.a(new_n455_), .b(new_n448_), .O(new_n456_));
  inv1 g370(.a(new_n456_), .O(new_n457_));
  nor2 g371(.a(new_n457_), .b(G177gat), .O(new_n458_));
  nor2 g372(.a(new_n362_), .b(new_n332_), .O(new_n459_));
  nor2 g373(.a(new_n459_), .b(new_n458_), .O(new_n460_));
  inv1 g374(.a(new_n460_), .O(new_n461_));
  nor2 g375(.a(new_n268_), .b(new_n156_), .O(new_n462_));
  nor2 g376(.a(new_n435_), .b(new_n336_), .O(new_n463_));
  nor2 g377(.a(new_n437_), .b(new_n135_), .O(new_n464_));
  nor2 g378(.a(new_n464_), .b(new_n441_), .O(new_n465_));
  inv1 g379(.a(new_n465_), .O(new_n466_));
  nor2 g380(.a(new_n466_), .b(new_n463_), .O(new_n467_));
  inv1 g381(.a(new_n467_), .O(new_n468_));
  nor2 g382(.a(new_n468_), .b(new_n462_), .O(new_n469_));
  inv1 g383(.a(new_n469_), .O(new_n470_));
  nor2 g384(.a(new_n470_), .b(G165gat), .O(new_n471_));
  nor2 g385(.a(new_n268_), .b(new_n186_), .O(new_n472_));
  nor2 g386(.a(new_n435_), .b(new_n344_), .O(new_n473_));
  nor2 g387(.a(new_n437_), .b(new_n103_), .O(new_n474_));
  nor2 g388(.a(new_n474_), .b(new_n441_), .O(new_n475_));
  inv1 g389(.a(new_n475_), .O(new_n476_));
  nor2 g390(.a(new_n476_), .b(new_n473_), .O(new_n477_));
  inv1 g391(.a(new_n477_), .O(new_n478_));
  nor2 g392(.a(new_n478_), .b(new_n472_), .O(new_n479_));
  inv1 g393(.a(new_n479_), .O(new_n480_));
  nor2 g394(.a(new_n480_), .b(G171gat), .O(new_n481_));
  nor2 g395(.a(new_n481_), .b(new_n471_), .O(new_n482_));
  inv1 g396(.a(new_n482_), .O(new_n483_));
  nor2 g397(.a(new_n483_), .b(new_n461_), .O(new_n484_));
  nor2 g398(.a(new_n469_), .b(new_n202_), .O(new_n485_));
  nor2 g399(.a(new_n479_), .b(new_n231_), .O(new_n486_));
  nor2 g400(.a(new_n456_), .b(new_n233_), .O(new_n487_));
  nor2 g401(.a(new_n487_), .b(new_n486_), .O(new_n488_));
  nor2 g402(.a(new_n488_), .b(new_n483_), .O(new_n489_));
  nor2 g403(.a(new_n489_), .b(new_n485_), .O(new_n490_));
  inv1 g404(.a(new_n490_), .O(new_n491_));
  nor2 g405(.a(new_n491_), .b(new_n484_), .O(new_n492_));
  inv1 g406(.a(new_n446_), .O(new_n493_));
  nor2 g407(.a(new_n493_), .b(G159gat), .O(new_n494_));
  nor2 g408(.a(new_n494_), .b(new_n447_), .O(new_n495_));
  inv1 g409(.a(new_n495_), .O(new_n496_));
  nor2 g410(.a(new_n496_), .b(new_n492_), .O(new_n497_));
  nor2 g411(.a(new_n497_), .b(new_n447_), .O(new_n498_));
  inv1 g412(.a(new_n498_), .O(G866gat));
  nor2 g413(.a(new_n487_), .b(new_n458_), .O(new_n500_));
  inv1 g414(.a(new_n500_), .O(new_n501_));
  nor2 g415(.a(new_n501_), .b(new_n459_), .O(new_n502_));
  inv1 g416(.a(new_n459_), .O(new_n503_));
  nor2 g417(.a(new_n500_), .b(new_n503_), .O(new_n504_));
  nor2 g418(.a(new_n504_), .b(new_n287_), .O(new_n505_));
  inv1 g419(.a(new_n505_), .O(new_n506_));
  nor2 g420(.a(new_n506_), .b(new_n502_), .O(new_n507_));
  nor2 g421(.a(new_n501_), .b(new_n293_), .O(new_n508_));
  nor2 g422(.a(new_n296_), .b(new_n233_), .O(new_n509_));
  nor2 g423(.a(new_n509_), .b(G246gat), .O(new_n510_));
  nor2 g424(.a(new_n510_), .b(new_n456_), .O(new_n511_));
  nor2 g425(.a(new_n309_), .b(new_n186_), .O(new_n512_));
  nor2 g426(.a(new_n307_), .b(new_n233_), .O(new_n513_));
  nor2 g427(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  inv1 g428(.a(new_n514_), .O(new_n515_));
  nor2 g429(.a(new_n515_), .b(new_n511_), .O(new_n516_));
  inv1 g430(.a(new_n516_), .O(new_n517_));
  nor2 g431(.a(new_n517_), .b(new_n508_), .O(new_n518_));
  inv1 g432(.a(new_n518_), .O(new_n519_));
  nor2 g433(.a(new_n519_), .b(new_n507_), .O(new_n520_));
  inv1 g434(.a(new_n520_), .O(G874gat));
  inv1 g435(.a(new_n492_), .O(new_n522_));
  nor2 g436(.a(new_n495_), .b(new_n522_), .O(new_n523_));
  nor2 g437(.a(new_n497_), .b(new_n287_), .O(new_n524_));
  inv1 g438(.a(new_n524_), .O(new_n525_));
  nor2 g439(.a(new_n525_), .b(new_n523_), .O(new_n526_));
  nor2 g440(.a(new_n496_), .b(new_n293_), .O(new_n527_));
  nor2 g441(.a(new_n296_), .b(new_n201_), .O(new_n528_));
  nor2 g442(.a(new_n528_), .b(G246gat), .O(new_n529_));
  nor2 g443(.a(new_n529_), .b(new_n446_), .O(new_n530_));
  nor2 g444(.a(new_n307_), .b(new_n201_), .O(new_n531_));
  inv1 g445(.a(G268gat), .O(new_n532_));
  nor2 g446(.a(new_n532_), .b(new_n309_), .O(new_n533_));
  nor2 g447(.a(new_n533_), .b(new_n531_), .O(new_n534_));
  inv1 g448(.a(new_n534_), .O(new_n535_));
  nor2 g449(.a(new_n535_), .b(new_n530_), .O(new_n536_));
  inv1 g450(.a(new_n536_), .O(new_n537_));
  nor2 g451(.a(new_n537_), .b(new_n527_), .O(new_n538_));
  inv1 g452(.a(new_n538_), .O(new_n539_));
  nor2 g453(.a(new_n539_), .b(new_n526_), .O(new_n540_));
  inv1 g454(.a(new_n540_), .O(G878gat));
  nor2 g455(.a(new_n485_), .b(new_n471_), .O(new_n542_));
  inv1 g456(.a(new_n488_), .O(new_n543_));
  nor2 g457(.a(new_n543_), .b(new_n460_), .O(new_n544_));
  nor2 g458(.a(new_n544_), .b(new_n481_), .O(new_n545_));
  nor2 g459(.a(new_n545_), .b(new_n542_), .O(new_n546_));
  inv1 g460(.a(new_n542_), .O(new_n547_));
  inv1 g461(.a(new_n545_), .O(new_n548_));
  nor2 g462(.a(new_n548_), .b(new_n547_), .O(new_n549_));
  nor2 g463(.a(new_n549_), .b(new_n287_), .O(new_n550_));
  inv1 g464(.a(new_n550_), .O(new_n551_));
  nor2 g465(.a(new_n551_), .b(new_n546_), .O(new_n552_));
  nor2 g466(.a(new_n547_), .b(new_n293_), .O(new_n553_));
  nor2 g467(.a(new_n296_), .b(new_n202_), .O(new_n554_));
  nor2 g468(.a(new_n554_), .b(G246gat), .O(new_n555_));
  nor2 g469(.a(new_n555_), .b(new_n469_), .O(new_n556_));
  nor2 g470(.a(new_n307_), .b(new_n202_), .O(new_n557_));
  nor2 g471(.a(new_n309_), .b(new_n155_), .O(new_n558_));
  nor2 g472(.a(new_n558_), .b(new_n557_), .O(new_n559_));
  inv1 g473(.a(new_n559_), .O(new_n560_));
  nor2 g474(.a(new_n560_), .b(new_n556_), .O(new_n561_));
  inv1 g475(.a(new_n561_), .O(new_n562_));
  nor2 g476(.a(new_n562_), .b(new_n553_), .O(new_n563_));
  inv1 g477(.a(new_n563_), .O(new_n564_));
  nor2 g478(.a(new_n564_), .b(new_n552_), .O(new_n565_));
  inv1 g479(.a(new_n565_), .O(G879gat));
  nor2 g480(.a(new_n486_), .b(new_n481_), .O(new_n567_));
  nor2 g481(.a(new_n487_), .b(new_n460_), .O(new_n568_));
  inv1 g482(.a(new_n568_), .O(new_n569_));
  nor2 g483(.a(new_n569_), .b(new_n567_), .O(new_n570_));
  inv1 g484(.a(new_n567_), .O(new_n571_));
  nor2 g485(.a(new_n568_), .b(new_n571_), .O(new_n572_));
  nor2 g486(.a(new_n572_), .b(new_n287_), .O(new_n573_));
  inv1 g487(.a(new_n573_), .O(new_n574_));
  nor2 g488(.a(new_n574_), .b(new_n570_), .O(new_n575_));
  nor2 g489(.a(new_n571_), .b(new_n293_), .O(new_n576_));
  nor2 g490(.a(new_n296_), .b(new_n231_), .O(new_n577_));
  nor2 g491(.a(new_n577_), .b(G246gat), .O(new_n578_));
  nor2 g492(.a(new_n578_), .b(new_n479_), .O(new_n579_));
  nor2 g493(.a(new_n307_), .b(new_n231_), .O(new_n580_));
  nor2 g494(.a(new_n309_), .b(new_n156_), .O(new_n581_));
  nor2 g495(.a(new_n581_), .b(new_n580_), .O(new_n582_));
  inv1 g496(.a(new_n582_), .O(new_n583_));
  nor2 g497(.a(new_n583_), .b(new_n579_), .O(new_n584_));
  inv1 g498(.a(new_n584_), .O(new_n585_));
  nor2 g499(.a(new_n585_), .b(new_n576_), .O(new_n586_));
  inv1 g500(.a(new_n586_), .O(new_n587_));
  nor2 g501(.a(new_n587_), .b(new_n575_), .O(new_n588_));
  inv1 g502(.a(new_n588_), .O(G880gat));
endmodule
